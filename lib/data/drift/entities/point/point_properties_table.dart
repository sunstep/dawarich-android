...
class PointPropertiesTable extends Table {
  ...
  TextColumn get batteryState => text()();           // Battery state (e.g., charging, full)
  RealColumn get batteryLevel => real()();           // Battery level (percentage as a double)
  TextColumn get wifi => text()();                   // Wi-Fi SSID
  TextColumn get timestamp => text()();              // e.g. ISO8601 string or Unix epoch as text
  ...
  TextColumn get trackId => text().nullable()();     // Track identifier (e.g. UUID), may be null
