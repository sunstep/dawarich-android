...
final class SetMinimumPointDistanceUseCase {

  final ITrackerSettingsRepository _trackerSettingsRepository;
  final SessionBox<User> _userSession;
  SetMinimumPointDistanceUseCase(this._trackerSettingsRepository, this._userSession);

  Future<Result<(), String>> call(int meters) async {
