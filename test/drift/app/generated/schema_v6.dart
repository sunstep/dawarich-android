...
class StatsCache extends Table with TableInfo<StatsCache, StatsCacheData> {
  ...
  late final GeneratedColumn<String> payloadJson = GeneratedColumn<String>(
      ...
      $customConstraints: 'NOT NULL');
  @override
  List<GeneratedColumn> get $columns => [id, syncedAt, payloadJson];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class StatsCacheData extends DataClass implements Insertable<StatsCacheData> {
  ...
  const StatsCacheData(
      {required this.id, required this.syncedAt, required this.payloadJson});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  StatsCacheData copyWith({int? id, int? syncedAt, String? payloadJson}) =>
      StatsCacheData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, syncedAt, payloadJson);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class StatsCacheCompanion extends UpdateCompanion<StatsCacheData> {
  ...
  StatsCacheCompanion copyWith(
      {Value<int>? id, Value<int>? syncedAt, Value<String>? payloadJson}) {
    return StatsCacheCompanion(
      id: id ?? this.id,
      syncedAt: syncedAt ?? this.syncedAt,
      payloadJson: payloadJson ?? this.payloadJson,
